...
class TestRobustness {
	...
	@Test
	@DisplayName("TC14 Expected result = Standard,purchaseTotal = -1(min-),frequency = 15(nom) ,pointCollected = 500(nom)")
	void test_14() {
		String result = ranking.CalculateMembershipRank(-1, 15,500);
	...
	@Test
	@DisplayName("TC15 Expected result = Gold,purchaseTotal = 100001(max+),frequency = 15(nom) ,pointCollected = 500(nom)")
	void test_15() {
		String result = ranking.CalculateMembershipRank(100001, 15,500);
		assertEquals("Gold", result);
	}
	
	@Test
	@DisplayName("TC16 Expected result = Standard,purchaseTotal = 50000(nom),frequency = -1(min-) ,pointCollected = 500(nom)")
	void test_16() {
		String result = ranking.CalculateMembershipRank(50000, -1,500);
		assertEquals("Invalid", result);
	}
	...
	@Test
	@DisplayName("TC17 Expected result = Gold,purchaseTotal = 50000(nom),frequency = 32(max+) ,pointCollected = 500(nom)")
	void test_17() {
		String result = ranking.CalculateMembershipRank(50000, 32,500);
		assertEquals("Gold", result);
	}
	
	@Test
	@DisplayName("TC18 Expected result = Standard,purchaseTotal = 50000(nom),frequency = 15(nom) ,pointCollected = -1(min-)")
	void test_18() {
		String result = ranking.CalculateMembershipRank(50000, 15,-1);
		assertEquals("Invalid", result);
	}
	...
	@Test
	@DisplayName("TC19 Expected result = Gold,purchaseTotal = 50000(nom),frequency = 15(nom) ,pointCollected = 1001(max+)")
	void test_19() {
		String result = ranking.CalculateMembershipRank(50000, 15,1001);
		assertEquals("Gold", result);
	}
